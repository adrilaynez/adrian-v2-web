export const en = {
    ...
    lab: {
        ...
        serverWarning: {
            ...
            message: "The server is waking up from hibernation. Free-tier Render instances spin down after inactivity ÔÇö yes, I'm hosting this on a free server because I'm a broke student.",
    ...
    landing: {
        hero: {
            ...
            tagline2: "Mechanistic Interpretability ┬À High-Performance Engineering.",
            cta: {
                lab: "View Lab Work",
                notes: "Read Notes",
            },
        ...
        about: {
            ...
            projectTitle: "Deep Learning Engine ÔÇö CUDA / C++",
            ...
            bio: {
                ...
                p1: "I am pursuing a double degree in <strong class='text-foreground'>Mathematics and Computer Science</strong> at the Universidad Complutense de Madrid. My research focuses on understanding neural networks at their deepest level ÔÇö from gradient dynamics to kernel-level optimization.",
                p2: "I specialize in <strong class='text-foreground'>Mechanistic Interpretability</strong> ÔÇö the science of reverse-engineering how neural networks represent and process information internally. Rather than treating models as black boxes, I decompose their circuits to understand <em class='text-foreground/80'>why they work</em>.",
        ...
        work: {
            ...
            items: {
                nanoTransformer: {
                    ...
                    desc: "Ground-up reproduction of 'Attention Is All You Need' in PyTorch ÔÇö Multi-Head Attention, Positional Encodings, and LayerNorm implemented without pre-built Transformer modules.",
                },
                cudaKernels: {
                    title: "CUDA Matrix Kernels",
                    desc: "Handwritten CUDA kernels exploring SGEMM optimization ÔÇö from naive implementations to tiled shared-memory strategies, benchmarked against cuBLAS.",
                },
                autograd: {
                ...
                mathDl: {
                    ...
                    desc: "Interactive articles exploring the rigorous theory behind modern AI ÔÇö SGD convergence analysis, the linear algebra of LoRA, and differential geometry on neural manifolds.",
                },
                distributed: {
        ...
        contact: {
            ...
            description: "Whether it's a research collaboration, an internship opportunity, or just a conversation about the mathematics of intelligence ÔÇö I'd love to hear from you.",
            email: "Get in Touch",
    ...
    projects: {
        ...
        flagship: {
            ...
            title: "LM-Lab",
            description: "An interactive platform for exploring language model architectures from first principles. Visualize transition matrices, probe inference dynamics, and generate text ÔÇö all powered by a live FastAPI backend with PyTorch.",
            highlights: {
                inference: {
    ...
    models: {
        bigram: {
            ...
            matrix: {
                ...
                searchPlaceholder: "Highlight characterÔÇª",
        ...
        ngram: {
            ...
            explosion: {
                title: "Context Too Large ÔÇö Combinatorial Explosion",
    ...
    bigramNarrative: {
        ...
        problem: {
            ...
            p2: " ÔÇö is what makes language both expressive and predictable. It's also what makes it so hard to model computationally.",
        ...
        coreIdea: {
            ...
            p3: "We model P(x_{t+1} | x_t) ÔÇö the chance of seeing a particular next token given only the token we just observed. Nothing more, nothing less. This radical simplification is what makes the model both tractable and limited.",
            calloutTitle: "Key Insight",
            calloutP1: "The \"bi\" in Bigram means ",
            calloutH1: "two",
            calloutP2: ". The model considers pairs of tokens ÔÇö the current one and the next one. It has zero memory of anything before the current token."
        },
        mechanics: {
            label: "Mechanics",
            ...
            h1: "matrix",
            p2: " ÔÇö a two-dimensional table where rows represent the current token and columns represent the next token. Each cell holds the number of times that specific transition was observed in the training data.",
            p3: "The visualization below is a live rendering of this transition matrix. Brighter cells indicate more frequent pairings ÔÇö patterns the model has learned from real text.",
        ...
        normalization: {
            ...
            p2: " of the count matrix ÔÇö dividing every count by the total number of transitions from that row's token. After normalization, each row sums to 1.0, forming a valid probability distribution.",
            ...
            p4: "Try it yourself below. Type any text to see what the model predicts will come next ÔÇö based ",
        ...
        sampling: {
            ...
            calloutP4: ", it samples more uniformly ÔÇö producing surprising and often nonsensical output.",
        ...
        limitations: {
            title: "Limitations",
            lead: "Bigram has no memoryÔÇöonly the last token.",
