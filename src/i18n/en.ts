export const en = {
    ...
    models: {
        ...
        neuralNetworks: {
            ...
            sections: {
                artificialNeuron: { number: "02", label: "Assembly" },
                nonLinearity: { number: "03", label: "Scaling Up" },
                howItLearns: { number: "04", label: "Learning" },
                training: { number: "05", label: "Training" },
                fromNumbers: { number: "06", label: "Language" },
                overfitting: { number: "07", label: "Overfitting" },
                playground: {
                    inputs: {
                        title: "Inputs",
    ...
    neuralNetworkNarrative: {
        ...
        discovery: {
            ...
            hookP1: "That's exactly what a neural network does. Instead of storing a giant table, it takes numbers as input, does some math, and produces an output. The trick is ",
            hookP1Highlight: "finding the right math — the right recipe",
            hookP1End: " — that turns inputs into good predictions.",
            hookP2: "So let's build that recipe from scratch. We start with the simplest question: you have two numbers and you need to combine them into one. What could you do?",
            p1: "Let's start with the basics. You have two numbers — say, 3 and 5. You need to combine them into one output. What are your options?",
            ...
            p2: "Addition treats both inputs equally. But what if one number matters more than the other? Multiply each input by an 'importance factor' — a weight — and the output becomes tunable.",
            ...
            p3: "One more piece. What if you want a baseline tendency — a default output even when both inputs are zero? Add a constant called a bias.",
            ...
            weights: {
                ...
                inputLabel1: "x₁ (likes action)",
                inputLabel2: "x₂ (likes comedy)",
                weightLabel: "Weight",
            ...
            challenge1: {
                question: "Switch to Weighted Sum and set x₁ = 3, x₂ = 5. What result do you get when both weights are 1?",
                hint: "With weights at 1, the weighted sum is just plain addition.",
                success: "Exactly! 1×3 + 1×5 = 8. Weights at 1 mean each input contributes equally — just like plain addition.",
            },
            challenge2: {
                question: "Make x₁ contribute more than x₂ to the output. Can you find a weight combination where x₁ accounts for over 70% of the total?",
                hint: "Try dragging w₁ up and w₂ down. Watch the contribution bar shift.",
                success: "You got it! A higher w₁ amplifies x₁'s influence. This is exactly how a neuron learns to pay attention to what matters.",
            },
        },
        hero: {
        ...
        nonLinearity: {
            ...
            parallelIntro: "Now that we have depth, let's add width. Instead of one neuron per layer, put several side by side — all looking at the same inputs, each with its own weights and bias.",
            ...
            boundaryIntro: "Here's what that buys you. A single neuron draws one straight line through the data and says \"everything on this side is A, everything on that side is B.\" Multiple neurons draw multiple lines — and together they can carve the space into complex regions. Try it:",
        ...
        howItLearns: {
            ...
            phaseA: {
                p1: "Let's make this concrete. Suppose we know the right answer: when the inputs are 1 and 2, the output should be 3. But right now, the model has random weights (w₁ = 4, w₂ = 3), so it computes 4×1 + 3×2 = 10. That's way off — it should be 3, not 10.",
                hint: "The model computes w₁ × x₁ + w₂ × x₂. With the wrong weights, it gets the wrong answer.",
                p2: "The output is 10, but we wanted 3. The only things we can change are the weights — the inputs are fixed data. So how would YOU adjust w₁ and w₂ to make the output closer to 3? Try it:",
            },
            phaseB: {
            ...
            phaseE: {
                intro: "We know the output is too high (10 instead of 3) and we know each weight's leverage. But should we increase the weight or decrease it to fix the error?",
            ...
            predictionError: { title: "Prediction vs Reality", expected: "Expected", got: "Got", error: "Error", offBy: "The model is way off. How can we fix the weights to get closer to 3?" },
            nudge: {
                ...
                effectOfW1: "Effect of w₁",
                effectOfW2: "Effect of w₂",
        ...
        watchingItLearn: {
            ...
            termBatchDesc: "A subset of training data used per step. Processing everything at once is too expensive, so we split the data into small chunks.",
        ...
        training: {
            ...
            repeatedChallenge: {
                question: "Can you get the loss below 0.5 in under 15 clicks?",
                hint: "Each click runs one full training step. The loss drops fast at first — use that momentum.",
                success: "Under 15 steps to loss < 0.5! Early training is efficient because the gradients are steep. Later steps make smaller refinements.",
            },
        ...
        fromNumbers: {
            ...
            networkViz: {
                ...
                arch: "1 input → 4 hidden → 27 outputs",
                inputPrompt: "Click an input character",
                topPredictions: "Top predictions",
                hint: "The glowing neurons are the top-3 predictions. Click different inputs to see how the distribution shifts.",
            },
