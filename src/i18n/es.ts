...
export const es: TranslationDictionary = {
    ...
    models: {
        ...
        neuralNetworks: {
            ...
            sections: {
                ...
                howItLearns: { number: "04", label: "Aprendizaje" },
                training: { number: "05", label: "Entrenamiento" },
                fromNumbers: { number: "06", label: "Lenguaje" },
                overfitting: { number: "07", label: "Sobreajuste" },
                playground: {
                    inputs: {
                        title: "Entradas",
    ...
    neuralNetworkNarrative: {
        ...
        discovery: {
            ...
            hookP1: "La idea es esta: en lugar de una tabla de búsqueda gigante, ¿y si le diéramos a una máquina un puñado de números ajustables — y dejáramos que ",
            hookP1Highlight: "descubra los valores correctos mirando ejemplos",
            hookP1End: "? Sin memorización. Sin tabla. Solo números que mejoran con la práctica.",
            hookP2: "Pero una máquina solo entiende números. Así que antes de nada, necesitamos responder una pregunta simple: ¿cómo combinas números para producir una salida útil?",
            p1: "Empecemos con lo básico. Tienes dos números — digamos, 3 y 5. Necesitas combinarlos en una salida. ¿Cuáles son tus opciones?",
            ...
            p2: "La suma trata ambas entradas por igual. Pero ¿y si un número importa más que el otro? Multiplica cada entrada por un 'factor de importancia' — un peso — y la salida se vuelve ajustable.",
            ...
            p3: "Una pieza más. ¿Y si quieres una tendencia base — una salida por defecto incluso cuando ambas entradas son cero? Añade una constante llamada sesgo.",
            ...
            weights: {
                ...
                inputLabel1: "x₁ (le gusta la acción)",
                inputLabel2: "x₂ (le gusta la comedia)",
                weightLabel: "Peso",
            ...
            challenge1: {
                question: "Cambia a Suma Ponderada y pon x₁ = 3, x₂ = 5. ¿Qué resultado obtienes cuando ambos pesos son 1?",
                hint: "Con pesos en 1, la suma ponderada es simplemente una suma normal.",
                success: "¡Exacto! 1×3 + 1×5 = 8. Pesos en 1 significa que cada entrada contribuye por igual — igual que una suma normal.",
            },
            challenge2: {
                question: "Haz que x₁ contribuya más que x₂ a la salida. ¿Puedes encontrar una combinación de pesos donde x₁ represente más del 70% del total?",
                hint: "Prueba a subir w₁ y bajar w₂. Observa cómo se desplaza la barra de contribución.",
                success: "¡Lo conseguiste! Un w₁ mayor amplifica la influencia de x₁. Así es exactamente como una neurona aprende a prestar atención a lo que importa.",
            },
        },
        hero: {
        ...
        nonLinearity: {
            ...
            parallelIntro: "Ahora que tenemos profundidad, añadamos anchura. En lugar de una neurona por capa, pon varias lado a lado — todas mirando las mismas entradas, cada una con sus propios pesos y sesgo.",
            ...
            boundaryIntro: "Esto es lo que eso te da. Una sola neurona traza una línea recta por los datos y dice “todo a este lado es A, todo al otro lado es B.”. Varias neuronas trazan varias líneas — y juntas pueden dividir el espacio en regiones complejas. Pruébalo:",
        ...
        howItLearns: {
            ...
            phaseA: {
                p1: "Hagámoslo concreto. Supón que sabemos la respuesta correcta: cuando las entradas son 1 y 2, la salida debería ser 3. Entrenamos al modelo dándole ejemplos donde ya conocemos la respuesta. Pero ahora mismo el modelo tiene pesos aleatorios (w₁ = 4, w₂ = 3), así que calcula 4×1 + 3×2 = 10. Está muy lejos — debería ser 3, no 10.",
                hint: "El modelo calcula w₁ × x₁ + w₂ × x₂. Con los pesos incorrectos, obtiene la respuesta incorrecta.",
                p2: "La salida es 10, pero queríamos 3. El único que podemos cambiar son los pesos — las entradas son datos fijos. Entonces, ¿cómo ajustarías TÚ w₁ y w₂ para acercar la salida a 3? Pruébalo:",
            },
            phaseB: {
            ...
            phaseE: {
                intro: "Sabemos que la salida es demasiado alta (10 en vez de 3). Sabemos qué pesos afectan la salida y cuánto. Pero saber el tamaño del efecto no basta — necesitamos la dirección. ¿Aumentamos el peso o lo disminuimos?",
            ...
            predictionError: { title: "Predicción vs Realidad", expected: "Esperado", got: "Obtenido", error: "Error", offBy: "El modelo está muy lejos. ¿Cómo podemos arreglar los pesos para acercarnos a 3?" },
            nudge: {
                ...
                effectOfW1: "Efecto de w₁",
                effectOfW2: "Efecto de w₂",
        ...
        watchingItLearn: {
            ...
            termBatchDesc: "Un subconjunto de datos de entrenamiento usado por paso. Procesar todo a la vez es demasiado costoso, así que dividimos los datos en trozos pequeños.",
        ...
        training: {
            ...
            repeatedChallenge: {
                question: "¿Puedes bajar la pérdida por debajo de 0.5 en menos de 15 clics?",
                hint: "Cada clic ejecuta un paso de entrenamiento completo. La pérdida baja rápido al principio — aprovecha ese impulso.",
                success: "¡Menos de 15 pasos para pérdida < 0.5! El entrenamiento temprano es eficiente porque los gradientes son pronunciados. Los pasos posteriores hacen ajustes más pequeños.",
            },
            ...
            textDemo: {
                title: "Datos de Entrenamiento desde Texto",
        ...
        fromNumbers: {
            ...
            networkViz: {
                ...
                arch: "1 entrada → 4 ocultas → 27 salidas",
                inputPrompt: "Haz clic en un carácter de entrada",
                topPredictions: "Mejores predicciones",
                hint: "Las neuronas brillantes son las 3 mejores predicciones. Haz clic en diferentes entradas para ver cómo cambia la distribución.",
            },
