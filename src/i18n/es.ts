...
export const es: TranslationDictionary = {
    ...
    neuralNetworkNarrative: {
        ...
        history: {
            ...
            p1: "En 1943, McCulloch y Pitts propusieron que una célula cerebral podía modelarse como una puerta lógica: recibe señales y, si son lo suficientemente fuertes, dispara. Demostraron que redes de estas unidades podían computar cualquier cosa.",
            p2: "En 1958, Frank Rosenblatt construyó el Perceptrón Mark I en Cornell — la primera máquina que aprendía de la experiencia. Ajustaba sus propios parámetros para reconocer formas simples.",
            p3: "En 1969, Minsky y Papert demostraron que los perceptrones de una sola capa tenían límites fundamentales. No podían aprender XOR. La financiación se secó. El Invierno de la IA duró casi dos décadas.",
            p4: "En 1986, Rumelhart, Hinton y Williams publicaron su artículo sobre la retropropagación — el algoritmo que mostró que las redes multicapa podían aprender. El deshielo comenzó.",
            p5: "Tomó otros 25 años, conjuntos de datos masivos y la revolución de las GPU antes de que el aprendizaje profundo conquistara el mundo. Pero la semilla plantada en 1943 nunca dejó de crecer.",
        },
